...
mod_meta   <- read_rds(here::here("model_output_reanalysis", "meta_brm_multi_id.rds"))
mod_ppt    <- read_rds(here::here("model_output_reanalysis", "ma_moderators_ppt.rds"))
mod_temp   <- read_rds(here::here("model_output_reanalysis", "ma_moderators_temp.rds"))
mod_lat    <- read_rds(here::here("model_output_reanalysis", "ma_moderators_lat.rds"))
mod_resp   <- read_rds(here::here("model_output_reanalysis", "ma_moderators_response_variable.rds"))
mod_time   <- read_rds(here::here("model_output_reanalysis", "ma_moderators_time.rds"))
mod_covars <- read_rds(here::here("model_output_reanalysis", "ma_moderators_covariates.rds"))
